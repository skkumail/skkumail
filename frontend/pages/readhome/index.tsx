...
const List2 = styled.div`
  ...
  gap: 8px;
`;
const ReadHomeChild = styled.img`
  position: absolute;
  top: 817px;
  left: 202.5px;
  width: 1px;
...
const List5 = styled.div`
  ...
  gap: 8px;
`;
const ReadHomeInner = styled.img`
  position: absolute;
  top: 350px;
  left: 1146.5px;
  width: 1px;
...
const LineIcon = styled.img`
  ...
  height: 25.5px;
`;
const ReadHomeChild1 = styled.img`
  position: absolute;
  top: 583px;
  left: 214.5px;
  width: 1px;
  height: 25.5px;
`;
const ReadHomeChild2 = styled.img`
  position: absolute;
  top: 694px;
  left: 199.5px;
  width: 1px;
  height: 25.5px;
`;
const ReadHomeChild3 = styled.img`
  position: absolute;
  top: 461px;
  left: 1117.5px;
  width: 1px;
  height: 25.5px;
`;
const ReadHomeChild4 = styled.img`
  position: absolute;
  top: 584px;
  left: 1134.5px;
  width: 1px;
  height: 25.5px;
`;
const ReadHomeChild5 = styled.img`
  position: absolute;
  top: 694px;
  left: 1094.5px;
  width: 1px;
  height: 25.5px;
`;
const ReadHomeChild6 = styled.img`
  position: absolute;
  top: 818px;
  left: 1142.5px;
  width: 1px;
...
const ReadHome: FunctionComponent = () => {
  return (
    <ReadHomeRoot>
      ...
      <Search>
        <InputContent>
          ...
          <InputContent1>
            <Search1>수신인이나 키워드를 검색하세요.</Search1>
          </InputContent1>
        </InputContent>
      </Search>
      <Div1>현재 최신 메일 기준으로 조회 되고 있습니다.</Div1>
      <List>
        <ItemParent>
          <Item>
            <Avatars>
      ...
      <ReadHomeChild alt="" src="/line-34.svg" />
      <List3>
        <ItemParent>
          <Item>
            <Avatars>
      ...
      <ReadHomeItem alt="" src="/line-34.svg" />
      <List5>
        <ItemParent>
          <Item>
            <Avatars>
      ...
      <ReadHomeInner alt="" src="/line-34.svg" />
      <List6>
        <ItemParent>
          <Item>
            <Avatars>
      ...
      <ReadHomeChild1 alt="" src="/line-34.svg" />
      <ReadHomeChild2 alt="" src="/line-34.svg" />
      <ReadHomeChild3 alt="" src="/line-34.svg" />
      <ReadHomeChild4 alt="" src="/line-34.svg" />
      <ReadHomeChild5 alt="" src="/line-34.svg" />
      <ReadHomeChild6 alt="" src="/line-34.svg" />
    </ReadHomeRoot>
  );
};
